...
class HopsInventoriesController < ApplicationController
  ...
  def index
    hobo_index HopsInventory.viewable(current_user).apply_scopes(:search => [params[:search],:name,:comment,:location],
